...
export default function ForgotPassword() {
  ...
  const handleReset = async (e) => {
    ...
    if (error) {
      ...
      setModalMsg("Linku për resetimin e fjalëkalimit u dërgua në email-in tuaj!");
      setIsSuccess(true);
    }
        ...
        <div className="w-full max-w-[440px]">
            <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100">
                ...
                <div className="flex flex-col items-center text-center mb-8">
                    ...
                    <h1 className="serif text-2xl font-black text-[#0f172a] tracking-tight mb-2">Rivendos Fjalëkalimin</h1>
                    <p className="text-gray-400 text-[12px] font-medium leading-tight">Shkruani email-in tuaj për të marrë linkun</p>
                </div>
                ...
                <form onSubmit={handleReset} className="space-y-5">
                    <div className="space-y-2">
                        ...
                        <input 
                            ...
                            className="w-full p-4 bg-gray-50 border border-gray-100 rounded-xl outline-none focus:border-[#1e4a6e] focus:bg-white text-sm transition-all placeholder:text-gray-300 font-medium" 
                ...
                <div className="mt-8 pt-6 border-t border-gray-50 flex flex-col items-center gap-4 text-center">
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                        U kujtuat?
                        <Link href="/login" className="text-[#1a5f7a] hover:underline">Hyr Këtu</Link>
                    </p>
                </div>
            </div>
